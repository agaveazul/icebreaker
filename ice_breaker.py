...
def ice_break(name:str)->Tuple[PersonIntel, str]:
    ...
    # result = chain.invoke(input={"linkedin_information": linkedin_data, "twitter_information": tweets})['text']
    result = chain.invoke(input={"linkedin_information": linkedin_data})['text']
    print(result)
